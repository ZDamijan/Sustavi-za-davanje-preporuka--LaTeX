...
korisnik ili sadržaj koji nema sličnosti sa niti jednim drugim korisnikom ili sadržajem (eng. black sheep), problem raznolikosti ili pretreniranja (eng. diversity ili overfitting) i problem manipulacije sustava (shilling attacks) te pitanje sigurnosti i privatnosti. Objašnjenje i vizualni prikaz navednih nedostataka dan je u \ref{ch: nedostaci personaliziranih sustava} poglavlju.
...
% odlomak
\par
Kako bi se dobile šro bolje preporuke i i(eng. hybrid methods)
...
% odlomak
\par
\ref{ch: evalucija sustava} poglavlju.
% odlomak
\par
\ref{ch: trenutni izazovi i buducnost} poglavlju.
% lista
\bigskip
