...
\item facebook.com, myspace.com, linkedin.com, gotinder.com - osobe
...
\bigskip
\\ Primjeri lista preporuka nepersonaliziranih sustava neke e-trgovine:
\begin{itemize}[topsep=2pt]
\setlength{\parskip}{0pt}
\item trenutno pregledavani proizvodi
\item najnoviji proizvodi
\item najprodavaniji proizvodi
\item najpopularniji proizvodi
\item najbolje ocijenjeni proizvodi
\item korisnici koji su kupili ovaj proizvod kupili su i sljedeće proizvode
\end{itemize}
%
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{slike/amazon-non_personalized_recom.png}
\caption{Primjeri nepersonaliziranih preporuka na web stranici amazon.com}
\end{center}
\end{figure}
%
\bigskip
\par Prednost personaliziranih sustava je što analiziraju podatke o korisnicima, njihovim aktivnostima u prošlostima, njihove ocjene proizvoda, njihove odnose s drugim korisnicima, njihovj trenutnoj poziciji i slično te podatke o samom sadržaju. Najčešći nedostaci takhvih sustava su pitanje privatnosti i sigurnosti, premalo informacija o novom korisniku ili novom sadržaju (eng. cold start), problem skalabilnosti (eng. scalability) te problem rapršenosti (eng. sparsity) u sutavima gdje postoji velika količina sadržaja, a jako mali broj korisnika koji je neki saržaj ocijenio, pregledao ili slično, problem korisnika koji nema sličnosti sa niti jednim drugim korisnikom (eng. black sheep) i problem manipulacije sustava (shilling attacks).
\bigskip
%
\begin{figure}
\begin{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{slike/content-for-user.jpg}
\caption{Primjeri personaliziranih preporuka na web stranici amazon.com}
\end{center}
\end{figure}
%
...
\lstinputlisting[caption=Test from file]{kodovi/kNN_user_based_recom.m}
