...
% odlomak
\par
Sustavi temeljeni na memoriji i modelu pripadaju skupini sustava temeljenih na suradnji (eng. collaborative filtering) jer se baziraju na podacima dobivenim zajedničkim radnjama korisnika, kao što su ocijenjivanje, kupovanje, pregledavanje i sl. Formalni opis i primjeri različitih implementacija ovih metoda odrađeni su u \ref{ch: sustavi temeljeni na suradnji} poglavlju.
% odlomak
\par
...
Pregled novih metoda nalazi se u  \ref{ch: pregled novih metode} poglavlju.
